...
const Menu = ({ setShowMenu }) => {
  return (
    <nav className="container mt-3 border py-3 border-gray-200 flex flex-row place-content-between">
      ...
      <div className="flex flex-row place-content-stretch">
        <ul className="flex gap-x-8 font-normal text-sm text-gray-600 mt-2">
          <li>Home</li>
          <li>Product</li>
          <li>Blog</li>
          <li
