...
const Header = () => {
  return <nav className="bg-gray-800 p-4 flex items-center justify-between">
  <div className="flex items-center">
      ...
      <ul className="flex space-x-4">
          ...
          <li><Link href="/product" className="text-white hover:text-gray-300">Products</Link></li>
          <li><Link href="/aboutus" className="text-white hover:text-gray-300">About Us</Link></li>
      </ul>
  </div>
